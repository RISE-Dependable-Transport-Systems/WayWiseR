...
class URM14PublisherNode(Node):
    def __init__(self):
        ...
        slave_address_hex_string = self.get_parameter('slave_address').get_parameter_value().string_value
        ...
        self.get_logger().info(f'URM14 Publisher Node has been initialized with port {self.rs485_port} on slave address {hex(self.slave_address)}.')
