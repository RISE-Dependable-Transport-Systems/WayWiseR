...
def generate_launch_description():
    ...
    waywise_autopilot_node_launch_action = OpaqueFunction(function=waywise_autopilot_node_launch)
    ...
    # start nodes
    ld.add_action(waywise_autopilot_node_launch_action)

    return ld


def waywise_autopilot_node_launch(context):
    nodes = []
