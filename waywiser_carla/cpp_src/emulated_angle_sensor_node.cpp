...
class EmulatedAngleSensorNode : public rclcpp::Node
{
public:
  EmulatedAngleSensorNode()
  : Node("emulated_angle_sensor_node")
  {
    ...
    timer_ = rclcpp::create_timer(
      ...
      std::bind(&EmulatedAngleSensorNode::calculateAngle, this)
    );
  }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<EmulatedAngleSensorNode>());
  rclcpp::shutdown();
  return 0;
}
