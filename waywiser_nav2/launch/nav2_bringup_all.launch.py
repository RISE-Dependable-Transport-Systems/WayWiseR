...
# Adapted original file from
#     https://github.com/ros-planning/navigation2/blob/humble/nav2_bringup/launch/navigation_launch.py
# to WayWiseR project.
...
def generate_launch_description():
    ...
    remappings = [('/tf', 'tf'), ('/tf_static', 'tf_static'), ('/bond', '/bond_nav2')]
    ...
    composable_nodes = [
        ...
        ComposableNode(
            ...
            name='velocity_smoother',
            parameters=[configured_params],
            remappings=remappings + [('cmd_vel', 'cmd_vel_nav'), ('cmd_vel_smoothed', 'nav2_vel')],
            extra_arguments=[{'use_intra_process_comms': True}],
        ),
        ComposableNode(
            package='nav2_lifecycle_manager',
    ...
    load_composable_nodes = GroupAction(
        ...
        actions=[
            ...
            ComposableNodeContainer(
                ...
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings + [('/bond', '/bond_nav2')],
                output='screen',
            ),
        ],
    )
