...
class EmergencyStopMonitorNode : public rclcpp::Node
{
public:
  EmergencyStopMonitorNode()
  : Node("emergency_stop_monitor")
  {
    ...
    emergency_stop_target_state_subscriber_ = this->create_subscription<EmergencyStopState>(
      ...
      std::bind(&EmergencyStopMonitorNode::emergency_stop_target_state_callback, this, _1));
    ...
    emergency_stop_state_publisher_timer_ = rclcpp::create_timer(
      ...
      std::bind(&EmergencyStopMonitorNode::emergency_stop_state_publisher_timer_callback, this)
    );
    ...
    twist_watchdog_timer_ = rclcpp::create_timer(
      ...
      std::bind(&EmergencyStopMonitorNode::twist_watchdog_callback, this)
    );

    twist_subscriber_ = this->create_subscription<geometry_msgs::msg::Twist>(
      "cmd_vel_in", 10, std::bind(&EmergencyStopMonitorNode::twist_callback, this, _1));
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<EmergencyStopMonitorNode>();
